...
Defined in: [packages/mermaid/src/config.type.ts:116](https://github.com/mermaid-js/mermaid/blob/master/packages/mermaid/src/config.type.ts#L116)
...
> `optional` **handDrawnProfile**: `"loose"` | `"artist"` | `"architect"` | `"marker"`
...
Defined in: [packages/mermaid/src/config.type.ts:171](https://github.com/mermaid-js/mermaid/blob/master/packages/mermaid/src/config.type.ts#L171)
...
Defined in: [packages/mermaid/src/config.type.ts:106](https://github.com/mermaid-js/mermaid/blob/master/packages/mermaid/src/config.type.ts#L106)
...
Defined in: [packages/mermaid/src/config.type.ts:115](https://github.com/mermaid-js/mermaid/blob/master/packages/mermaid/src/config.type.ts#L115)
...
> `optional` **securityLevel**: `"loose"` | `"strict"` | `"antiscript"` | `"sandbox"`
...
> `optional` **wireframe**: `WireframeDiagramConfig`
